...
hpg_store_info <- fread('../input/hpg_store_info.csv')
air_store_info <- fread('../input/air_store_info.csv')
store_id_relation <- fread('../input/store_id_relation.csv')# add date of week
```
...
---- That's it for today. I will have to go and study for all the math proofs in prepartion for my exam on Friday ----